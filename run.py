...
def create_parser():
    ...
    parser.add_argument('--backbone',       type=str,   default='phaspa',        help='backbone model for deterministic prediction')
    ...
    parser.add_argument("--layers",         type=int,   default=6,               help="layers number")
...
class Runner(object):
    ...
    def _build_model(self):
        ...
        elif self.args.backbone == 'phaspa':
            from models.phaspa import get_model
            kwargs = {
